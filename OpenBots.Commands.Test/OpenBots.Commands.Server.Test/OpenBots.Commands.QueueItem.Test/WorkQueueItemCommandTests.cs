...
namespace OpenBots.Commands.QueueItem.Test
{
    public class WorkQueueItemCommandTests
    {
        ...
        public async void WorkQueueItemNoAttachments()
        {
            ...
            var queueItemObject = (Dictionary<string, object>)await "{output}".EvaluateCodeForTests(_engine, typeof(Dictionary<,>));
        ...
        public async void WorkQueueItemOneAttachment()
        {
            ...
            var queueItemObject = await "{output}".EvaluateCodeForTests(_engine, typeof(Dictionary<,>));
