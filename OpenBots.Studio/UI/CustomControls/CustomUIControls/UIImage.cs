...
namespace OpenBots.UI.CustomControls.CustomUIControls
{
    public static class UIImage
    {
        public static Dictionary<string, Image> UIImageDictionary()
        {
            ...
            uiImages.Add("BrokenCodeCommentCommand", Resources.command_broken);
            ...
            uiImages.Add("GetMimeMessagePropertyCommand", Resources.command_smtp);
            uiImages.Add("GetOutlookEmailPropertyCommand", Resources.command_smtp);
            uiImages.Add("ErrorHandlingCommand", Resources.command_error);
            uiImages.Add("BeginTryCommand", Resources.command_try);
            uiImages.Add("CatchCommand", Resources.command_catch);
            uiImages.Add("FinallyCommand", Resources.command_try);
            uiImages.Add("EndTryCommand", Resources.command_end_try);
            uiImages.Add("ThrowCommand", Resources.command_exception);
            uiImages.Add("RethrowCommand", Resources.command_exception);
            uiImages.Add("BeginRetryCommand", Resources.command_try);
            uiImages.Add("EndRetryCommand", Resources.command_end_try);
            uiImages.Add("GetExceptionMessageCommand", Resources.command_exception);
