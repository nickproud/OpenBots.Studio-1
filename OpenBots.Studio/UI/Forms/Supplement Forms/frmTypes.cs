    ...
    public partial class frmTypes : UIForm
    {
        ...
        private void uiBtnOk_Click(object sender, EventArgs e)
        {
            ...
            if (tvTypes.SelectedNode.Nodes.Count == 0)
            {
                ...
                else if (SelectedType.FullName == "System.Array")
                    SelectedType = ConstructArrayType();
        ...
        {
            return ((Type)((ComboBox)flpTypeConstruction.Controls[0]).Tag).MakeArrayType();
        }
