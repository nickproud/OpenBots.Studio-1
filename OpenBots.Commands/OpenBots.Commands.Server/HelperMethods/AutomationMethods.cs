    ...
    public class AutomationMethods
    {
        public static AutomationModel UploadAutomation(string token, string serverUrl, string organizationId, string name, string filePath, string automationEngine)
        {
            ...
            try
            {
                ...
                {
                    var result = apiInstance.ApiVapiVersionAutomationsPostWithHttpInfo(apiVersion, organizationId, name, _file, automationEngine);
        ...
        public static void UpdateParameters(string token, string serverUrl, string organizationId, Guid? automationId, IEnumerable<AutomationParameter> automationParameters)
        {
            var apiInstance = GetApiInstance(token, serverUrl);
            ...
            try
            {
                ...
                apiInstance.ApiVapiVersionAutomationsAutomationIdUpdateParametersPostWithHttpInfo(automationId.ToString(), organizationId, apiVersion, automationParametersList);
            }
            catch (Exception ex)
            {
                throw new InvalidOperationException("Exception when calling AutomationsApi.ApiVapiVersionAutomationsPostAsyncWithHttpInfo: "
