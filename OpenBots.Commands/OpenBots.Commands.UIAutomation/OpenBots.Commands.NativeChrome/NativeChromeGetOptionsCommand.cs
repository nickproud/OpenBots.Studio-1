...
namespace OpenBots.Commands.NativeChrome
{
	...
	public class NativeChromeGetOptionsCommand : ScriptCommand
	{
		...
		public async override Task RunCommand(object sender)
		{
			...
			string responseText;
			NativeRequest.ProcessRequest("readtext", JsonConvert.SerializeObject(webElement), vTimeout, out responseText);
		...
		{
			return base.GetDisplayValue() + $" [{NativeHelper.GetSearchNameValue(v_NativeSearchParameters)} - Store Options in '{v_OutputUserVariableName}'" +
