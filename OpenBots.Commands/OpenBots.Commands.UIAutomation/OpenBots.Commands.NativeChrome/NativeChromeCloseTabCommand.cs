...
namespace OpenBots.Commands.NativeChrome
{
	...
	[Description("This command closes the currently active chrome tab.")]
	public class NativeChromeCloseTabCommand : ScriptCommand
	{
		[Required]
		...
		public NativeChromeCloseTabCommand()
		{
			CommandName = "NativeChromeCloseTabCommand";
			SelectionName = "Native Chrome Close Tab";
			CommandEnabled = true;
