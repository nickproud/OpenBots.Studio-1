...
namespace OpenBots.Commands.NativeChrome
{
	...
	[Description("This command navigates the browser to the provided URL.")]
	public class NativeChromeNavigateToURLCommand : ScriptCommand
	{
		[Required]
		...
		public NativeChromeNavigateToURLCommand()
		{
			CommandName = "NativeChromeNavigateToURLCommand";
			SelectionName = "Native Chrome Navigate To URL";
			CommandEnabled = true;
		...
		public async override Task RunCommand(object sender)
		{
			...
			string responseText;
			NativeRequest.ProcessRequest("navigatetourl", JsonConvert.SerializeObject(webElement), vTimeout, out responseText);
