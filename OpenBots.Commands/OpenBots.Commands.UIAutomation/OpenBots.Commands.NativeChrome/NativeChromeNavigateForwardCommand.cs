...
namespace OpenBots.Commands.NativeChrome
{
	...
	[Description("This command navigates forward through the Chrome history list.")]
	public class NativeChromeNavigateForwardCommand : ScriptCommand
	{
		[Required]
		...
		public NativeChromeNavigateForwardCommand()
		{
			CommandName = "NativeChromeNavigateForwardCommand";
			SelectionName = "Native Chrome Navigate Forward";
			CommandEnabled = true;
		...
		public async override Task RunCommand(object sender)
		{
			...
			string responseText;
			NativeRequest.ProcessRequest("navigateforward", JsonConvert.SerializeObject(webElement), vTimeout, out responseText);
