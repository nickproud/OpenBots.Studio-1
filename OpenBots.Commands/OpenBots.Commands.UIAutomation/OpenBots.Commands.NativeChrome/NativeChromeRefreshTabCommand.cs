...
namespace OpenBots.Commands.NativeChrome
{
	...
	[Description("This command refreshes the currently active chrome tab.")]
	public class NativeChromeRefreshTabCommand : ScriptCommand
	{
		[Required]
		...
		public NativeChromeRefreshTabCommand()
		{
			CommandName = "NativeChromeRefreshTabCommand";
			SelectionName = "Native Chrome Refresh Tab";
			CommandEnabled = true;
		...
		public async override Task RunCommand(object sender)
		{
			...
			string responseText;
			NativeRequest.ProcessRequest("refreshtab", JsonConvert.SerializeObject(webElement), vTimeout, out responseText);
