...
namespace OpenBots.Commands.Terminal
{
	...
	public class TerminalPromptForPasswordCommand : ScriptCommand
	{
		[Required]
		...
		public TerminalPromptForPasswordCommand()
		{
			CommandName = "TerminalPromptForPasswordCommand";
			SelectionName = "Prompt For Password";
			CommandEnabled = true;
		...
		public async override Task RunCommand(object sender)
		{
			...
			terminalObject.PromptForPassword();
		}
