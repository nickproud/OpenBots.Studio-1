...
namespace OpenBots.Server.SDK.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AutomationParameter :  IEquatable<AutomationParameter>, IValidatableObject
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AutomationParameter {\n");
        ...
        {
            return this.Equals(input as AutomationParameter);
        }

        /// <summary>
        /// Returns true if AutomationParameter instances are equal
        /// </summary>
        /// <param name="input">Instance of AutomationParameter to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AutomationParameter input)
        {
            if (input == null)
                return false;
